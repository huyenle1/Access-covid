...
annarbor_grocery = avg_polygon_to_shapefile_grocery("isochrones_annarbor", ["Jan07","Mar31", "Nov17"])
...
store_file_health_urgent("isochrones_nyc", ["Jan07","May05", "Dec08"], 'NYC')
...
store_file_health_nonurgent("isochrones_nyc", ["Jan07","May05", "Dec08"], 'NYC')
...
store_file_grocery("isochrones_nyc", ["Jan07","May05", "Dec08"], 'NYC')
